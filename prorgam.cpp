...
int main()
{
    ...
    user1.setdata(11102000,"SP",1110,100000,"9670646050");
    ...
    if (enter_account_number==user1.getaccountno() && enterPIN == user1.getpin());
        ...
        do
            ...
            cout<< endl<< "INFORMATION VALIDATED"<<endl;
            cout<< endl<< " CHOOSE THE OPTION FROM THE LIST ";
            cout<< endl<< "1. BALANCE CHECK";
            cout<< endl<< "2. CASH WITHDRAWAL";
            cout<< endl<< "3. MY INFORMATION";
            cout<< endl<< "4. UPDATE MOBILE NUMBER";
            cout<< endl<< "5. NOTHING JUST LOG OUT";
            cin>> choice;
